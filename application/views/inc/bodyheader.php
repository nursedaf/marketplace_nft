<header id="header_main" class="header_1 js-header">
                        ...
                        <div id="site-logo" class="clearfix">
                            <div id="site-logo-inner">
                                <a href="<?php echo base_url(); ?>" rel="home" class="main-logo">
                                    <img id="logo_header" src="<?php echo base_url(cekInfo()->logo); ?>" alt="nft-gaming" width="133" height="56" data-retina="<?php echo base_url(); ?>assetsimages/logo/logo_dark.png" data-width="133" data-height="56">
                                </a>
                            </div>
                        </div>
    ...
    <div class="mode_switcher">
        ...
        <a href="<?php echo base_url(); ?>" class="light d-flex align-items-center">
            <img src="<?php echo base_url(); ?>assets/images/icon/sun.png" alt="">
        </a>
        <a href="<?php echo base_url(); ?>" class="dark d-flex align-items-center is_active">
            <img id="moon_dark" src="<?php echo base_url(); ?>assets/images/icon/moon-2.png" alt="">
        </a>
    </div>
</header>
