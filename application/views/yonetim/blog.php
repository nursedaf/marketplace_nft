...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div class="d-flex flex-column flex-root">
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            <div class="card card-custom gutter-b example example-compact">
                                <form action="<?php echo base_url('yonetim/Pages/blogekle'); ?>" method="POST" enctype="multipart/form-data">
        ...
        <script src="<?php echo base_url('assets/yonetim/'); ?>assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js"></script>
        <script>
