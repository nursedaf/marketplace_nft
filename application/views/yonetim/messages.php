    ...
    <div class="d-flex flex-column flex-root">
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            <?php foreach ($message as $m) { ?>
                                <div class="card card-custom card-collapsed" data-card="true" id="kt_card_4<?php echo $m->id; ?>">
                                    <div class="card-header">
                                        <div class="card-title">
                                            <h3 class="card-label"><?php echo $m->name; ?></h3>
                                        </div>
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <a href="#" class="btn btn-icon btn-sm btn-light-danger" data-id="<?php echo $m->id; ?>" data-type="delete">
        ...
        <script>
            $(document).on('click', '[data-type="delete"]', function() {
                ...
                $.ajax({
                    url: "<?php echo base_url('yonetim/Pages/deletemessage'); ?>",
                    type: 'POST',
                    data: {
                        id: id,
                    },
