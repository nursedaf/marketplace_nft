                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="card card-custom gutter-b example example-compact">
                                        <form action="<?php echo base_url('yonetim/Pages/info'); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="card card-custom gutter-b example example-compact">
                                        <form action="<?php echo base_url('yonetim/Pages/contact'); ?>" method="POST">
                                            <div class="card-header">
                                                Contact
                                            </div>
                                            <div class="card-body">
