...
<header>
    ...
    <div class="container">
        <div class="row">
            <div class="col-3">
                <div id="logo_home">
                    <h1><a href="<?php echo base_url(); ?>" title="City tours travel template">City Tours travel template</a></h1>
                </div>
            </div>
            <nav class="col-9">
                ...
                <div class="main-menu">
                    <div id="header_menu">
                        <img src="<?php echo base_url('assets/site/'); ?>img/logo_sticky.png" width="160" height="34" alt="City tours">
                    </div>
                            ...
                            <ul>
                                ...
                                <li class="third-level"><a href="javascript:void(0);">Revolution slider <strong class="badge badge-danger">New!</strong></a>
                                    <ul>
                                        ...
                                        <li><a href="../index.html">Full Screen Slicey <strong class="badge badge-danger">New!</strong></a></li>
                    ...
                    <li>
                        <div class="dropdown dropdown-cart">
                            ...
                            <ul class="dropdown-menu" id="cart_items">
                                <li>
                                    <div class="image"><img src="<?php echo base_url('assets/site/'); ?>img/thumb_cart_1.jpg" alt="image"></div>
                                    <strong><a href="#">Louvre museum</a>1x $36.00 </strong>
                                    <a href="#" class="action"><i class="icon-trash"></i></a>
                                </li>
                                <li>
                                    <div class="image"><img src="<?php echo base_url('assets/site/'); ?>img/thumb_cart_2.jpg" alt="image"></div>
                                    <strong><a href="#">Versailles tour</a>2x $36.00 </strong>
                                    <a href="#" class="action"><i class="icon-trash"></i></a>
                                </li>
                                <li>
                                    <div class="image"><img src="<?php echo base_url('assets/site/'); ?>img/thumb_cart_3.jpg" alt="image"></div>
